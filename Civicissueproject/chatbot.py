...
def chat():
    ...
    if current_stage == 'INIT':
        if 'report an issue' in user_message:
            ...
            if 'user' in session:
                bot_response = "Hi! I’m Saity, your CityZen assistant. 😊 You can report any city issues here or check the status of a report you’ve submitted. How can I help you today?"
